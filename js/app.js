    ...
    (() => {
        ...
        if (player) {
            ...
            function togglePlay() {
                ...
                video[method]();
                if (video.play && windowWidth <= 768) {
                    controls.style.transform = "translateY(0)";
                    setTimeout((() => {
                        controls.style.transform = "translateY(100%)";
                    }), 4e3);
                } else if (video.paused && windowWidth <= 768) controls.style.transform = "translateY(0)";
            }
        ...
        if (menuLinks.length > 0) {
            ...
            menuLinks.forEach((menuLink => {
                if (menuLink.classList.contains("menu-list_right__link")) return; else if (menuLink.href === currentUrl) menuLink.classList.add("_active"); else if ("/product.html" === window.location.pathname || "/catalog-items.html" === window.location.pathname) document.querySelectorAll(".menu__link_catalog").forEach((linkCatalog => linkCatalog.classList.add("_active"))); else if ("/block-page.html" === window.location.pathname) document.querySelectorAll(".menu__link_blog").forEach((linkCatalog => linkCatalog.classList.add("_active")));
            }));
        }
        ...
        function documentActions(e) {
            ...
            if (targetElement.closest(".item-control__image-box_cart")) {
